...
class SMSverification extends Component {
    ...
    componentDidMount() {
        ...
        fetch(CONFIRM_ROUTE, requestOptions).then((response) => response.json()).then((data) => {
            if (data.isVerified) {
            ...
            return (
                <div className='welcomePage'>
                    ...
                    <div className='finished'>
                        ...
                        <p>Bitte habe kurz Gedult, unsere Datenbank gleicht gerade deine Informationen mit dem von dir verwendeten Link ab.</p>
                    </div>
                </div>
            )
            ...
            return (
                <div className='welcomePage'>
                    ...
                    <div className='finished'>
                        ...
                        <p>Super, deine Handynummer wurde soeben verifiziert. Du bist jetzt ein flugbereiter Endel!<br></br><bold>Bitte erinnere auch ggf. deinen Partner-Engel daran, seine Nummer zu validieren</bold></p>
                    </div>
                </div>
            )
